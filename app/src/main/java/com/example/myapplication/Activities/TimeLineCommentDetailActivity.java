...
public class TimeLineCommentDetailActivity extends AppCompatActivity {
    ...
    KeywordPostCommentAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUploadComment();
        getCommentData();
        adapter = new KeywordPostCommentAdapter(models,this);
    ...
    public void getCommentData(){
        for (int i = 0; i<5;i++) {
            KeywordPostCommentModel model = new KeywordPostCommentModel("하태영","2021-12-01","겨울~겨울~");
            models.add(model);
        }
