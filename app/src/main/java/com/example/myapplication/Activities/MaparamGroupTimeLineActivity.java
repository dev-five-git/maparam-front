...
public class MaparamGroupTimeLineActivity extends AppCompatActivity {
...
//                getChildFragmentManager().beginTransaction().replace(R.id.topLevel,new CommunityFragment(context)).commit();
                startActivity(new Intent(MaparamGroupTimeLineActivity.this, MaparamGroupCommentActivity.class));
            }
        });
    ...
    public void buildingFloatingAction(){
        addPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MaparamGroupTimeLineActivity.this, AddPostActivity.class);
                MaparamGroupTimeLineActivity.this.startActivity(intent);
            }
        });
    }
}